...
<template>
  <div class="body-container">
    <div class="container">
      <div class="header">
        <h1>Loan Calculator Components</h1>
        <p>List of Vue Loan Calculator components</p>
      </div>
      <div class="file-list">
        <RouterLink
          v-for="file in files"
...
.file-item:hover {
  ...
  box-shadow: 0 8px 20px rgba(245, 175, 25, 0.3);
}
